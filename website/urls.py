...
urlpatterns = [
    ...
    path('profile/<username>/disliked-drinks/',
         gnt_views.disliked_drinks, name='disliked_drinks'),
    ...
    path('profile/<username>/liked-drinks',
         gnt_views.liked_drinks, name='liked_drinks'),
    path('profile/<username>/notifications',
         gnt_views.notifications, name='notifications'),
    path('profile/<username>/timeline',
         gnt_views.profile_public, name='timeline'),

    # db api url patterns
    path('dislike_drink/', gnt_db_api.dislike_drink, name='dislike_drink'),
    path('dislike_user_drink/', gnt_db_api.dislike_user_drink,
         name='dislike_user_drink'),
    path('get_liked_disliked_drinks/', gnt_db_api.get_liked_disliked_drinks,
         name='get_liked_disliked_drinks'),
    path('get_liked_disliked_user_drinks/', gnt_db_api.get_liked_disliked_user_drinks,
         name='get_liked_disliked_user_drinks'),
    ...
    path('comment/', gnt_db_api.comment, name='comment'),
    # password reset url patterns
    path('password-reset/', auth_views.PasswordResetView.as_view(
        template_name='gnt/password_reset.html'), name='password_reset'),
